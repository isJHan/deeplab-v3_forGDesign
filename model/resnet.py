...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = out + x_downsample # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/2, w/2) if stride == 2)
...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 50:
            ...
            resnet.load_state_dict(torch.load("C:/Users/hanjm/Desktop/GDesign/deeplabv3/pretrained_models/resnet/resnet50-19c8e357.pth"))
...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 18:
            resnet = models.resnet18()
            # load pretrained model:
            resnet.load_state_dict(torch.load("C:/Users/hanjm/Desktop/GDesign/deeplabv3/pretrained_models/resnet/resnet18-5c106cde.pth"))
            # resnet.load_state_dict(torch.load("/root/deeplabv3/pretrained_models/resnet/resnet18-5c106cde.pth"))
